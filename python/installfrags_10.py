...
cmsswv = 'CMSSW_11_0_X_2019-06-27-1100'
...
def main():
    ...
    templateGen = cmsswv+'/src/Configuration/Generator/python/LLP_'+templatekey+'_cff.py'
    f = open(templateGen)
    ...
    for slha in slhas:
        ...
        frawslha.close()
        frawdecay = open(cmsswv+'/src/Customise/data/geant4_'+templatekey+'.slha')
        ...
        fslha = open(cmsswv+'/src/SigPoints/'+slhakey+'.slha','w')
        armed2comment = False
        width = -1.0
        chipmmass = -9999
        chi10mass = -9999
        ...
        fdecay = open(cmsswv+'/src/Customise/data/geant4_'+slhakey+'.slha','w')
        ...
        print 'check created frag:', cmsswv+'/src/Configuration/Generator/python/LLP_'+slhakey+'_cff.py'
        print ''
